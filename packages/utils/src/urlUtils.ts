...
export class Route {
  ...
  withQuery(q: Record<string, string | undefined | null>): Route {
    ...
    return new Route(
      { pathname: this.hrefPathname(), query, hash: this.getHash() },
      { pathname: this.asPathname(), query, hash: this.getHash() },
    );
  }
  ...
  withHash(hash?: string): Route {
    return new Route(
      { pathname: this.hrefPathname(), query: this.getQuery(), hash },
      { pathname: this.asPathname(), query: this.getQuery(), hash },
    );
  }
}
